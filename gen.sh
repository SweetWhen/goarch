...
protoc -I ./third_party/ -I ./ --go_out=./custompb --go_opt=module=github.com/SweetWhen/goarch/custompb \
        --go-grpc_out=./custompb --go-grpc_opt=module=github.com/SweetWhen/goarch/custompb custompb/proto/helloworld/*.proto \
        --sweet-gin_out=./custompb --sweet-gin_opt=module=github.com/SweetWhen/goarch/custompb custompb/proto/helloworld/*.proto
